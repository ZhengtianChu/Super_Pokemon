...
using namespace std;
class Scyzc3FilterPoints :
    public FilterPoints
{
public:
	Scyzc3FilterPoints(int xStretch, int xCompress, int yStretch, int yCompress, FilterPoints* pNextFilter = nullptr)
	...
	Scyzc3FilterPoints(int xFactor, int yFactor, FilterPoints* pNextFilter = nullptr)
...
class Scyzc3FilterPointsTranslation : public FilterPoints
{
public:
	Scyzc3FilterPointsTranslation(int xModifier, int yModifier, FilterPoints* pNextFilter = nullptr)
